          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   ...
                   <a href="/dashboard/products/create" class="btn btn-primary my-3">Add Product</a>
                </div>
             </div>
             <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/dashboard/products/{{ $product->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="badge bg-danger border-0" onclick="return confirm('Are you sure  to delete {{ $product->product_name }} | {{ $product->unit }}?')">
