          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   ...
                   <a href="/dashboard/zones/create" class="btn btn-primary my-3">Add New Zone</a>
                </div>
             </div>
             <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/dashboard/zones/{{ $zone->id }}/edit" class="badge bg-warning">
                                ...
                                <form action="/dashboard/zones/{{ $zone->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="badge bg-danger border-0" onclick="return confirm('Are you sure  to delete {{ $zone->zone_name }} : {{ $zone->zone_information }}?')">
