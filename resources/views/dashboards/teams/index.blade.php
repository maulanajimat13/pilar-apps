          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   ...
                   <a href="/dashboard/teams/create" class="btn btn-primary my-3">Add new team</a>
                </div>
             </div>
             <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/dashboard/teams/{{ $team->id }}/edit" class="badge bg-warning">
                                ...
                                <form action="/dashboard/teams/{{ $team->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="badge bg-danger border-0" onclick="return confirm('Are you sure  to delete team {{ $team->name }} ?')">
