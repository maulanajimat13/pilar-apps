<x-app-layout :assets="$assets ?? []">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Brand Presenter List</h4>
                        <a href="/dashboard/presenters/create" class="btn btn-primary my-3">Add New Brand Presenter</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($presenters as $presenter)
                                    <tr>
                                        ...
                                        <td>{{ $presenter->qris_name }}</td>
                                        <td>
                                            {{-- <a href="#myModal" type="" class="" data-bs-toggle="modal"
                                                data-bs-target="#myModal">Check Qr</a> --}}

                                            <a href="{{ $presenter->id }}" class="badge bg-info" data-bs-toggle="modal"
                                            data-bs-target="#{{ $presenter->id }}">
    ...
    <!-- Modal Caption (Image Text) --> --}}
                                            ...
                                            <div class="modal fade" id="{{ $presenter->id }}" tabindex="0"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">QR {{ $presenter->qris_name }}
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <!--        include image here-->
                                                            <img src="{{ asset('storage/' . $presenter->image) }}"
                                                                alt="Image Title" class="modal-content" id="img01">
                                                        </div>
                                            ...
                                            <a href="/dashboard/presenters/{{ $presenter->id }}/edit"
                                            ...
                                            <form action="/dashboard/presenters/{{ $presenter->id }}" method="post"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf
                                                <button class="badge bg-danger border-0"
                                                    onclick="return confirm('Are you sure  to delete brand presenter {{ $presenter->name }} ')">
                                                    <svg width="20" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    <script>
        ...
        // });
        var modal = document.getElementById({{ $presenter->id }});

// Get the image and insert it inside the modal - use its "alt" text as a caption
var img = document.getElementsByClassName('modal-content');
//window.alert(img);
var i = img.length;
var j;
