          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   ...
                   <a href="/dashboard/users/create" class="btn btn-primary my-3">Add New User</a>
                </div>
             </div>
             <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/dashboard/users/{{ $user->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="badge bg-danger border-0" onclick="return confirm('Are you sure  to delete {{ $user->username }} in role {{ $user->role }}?')">
