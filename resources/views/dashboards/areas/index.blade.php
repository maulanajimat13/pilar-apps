          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   ...
                   <a href="/dashboard/areas/create" class="btn btn-primary my-3">Add New Area</a>
                </div>
             </div>
             <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/dashboard/areas/{{ $area->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="badge bg-danger border-0" onclick="return confirm('Are you sure  to delete area {{ $area->area_name }} in {{ $area->zone->zone_name }}?')">
