          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   <h4 class="card-title">Team Leader List</h4>
                   <a href="/dashboard/teamleaders/create" class="btn btn-primary my-3">Add New Team Leader</a>
                </div>
             </div>
             <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- <a href="/dashboard/teamleaders/{{ $tL->id }}/edit" class="badge bg-warning">
                                ...
                                <form action="/dashboard/teamleaders/{{ $tL->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="badge bg-danger border-0" onclick="return confirm('Are you sure  to delete team leader {{ $tL->name }} ')">
