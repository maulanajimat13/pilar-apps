...
// Packages
use App\Http\Controllers\SaleExportExcel;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    // Route::get('/dashboard/products/index', [ProductsController::class, 'index'])->name('products');
    Route::resource('/dashboard/products',ProductController::class )->names([
        'index' => 'products'
    ]);

    //Dashboard Zone, Area and Routes
    Route::resource('/dashboard/zones',ZoneController::class )->names([
        'index' => 'zones'
    ]);
    Route::resource('/dashboard/areas',AreaController::class )->names([
        'index' => 'areas'
    ]);
    Route::resource('/dashboard/routes',RouteController::class )->names([
        'index' => 'routes'
    ]);

     //Dashboard Team Leaders, Brand Presenters, Teams
     Route::resource('/dashboard/teamleaders',TeamLeaderController::class )->names([
        'index' => 'teamleaders'
    ]);
    Route::resource('/dashboard/presenters', PresenterController::class)->names([
        'index' => 'presenters'
    ]);
    ...
    //Dashboard Sale, Manual Upload
    Route::resource('/dashboard/sales', SaleController::class)->names([
        'index' => 'sales'
    ]);
    Route::get('dashboard/sales/export_excel', [SaleExportExcel::class, 'export_excel']);


    // Users Module and admin
    Route::resource('users', UserController::class);
    });
    Route::resource('/dashboard/users',UserController2::class )->names([
        'index' => 'users'
    ]);
